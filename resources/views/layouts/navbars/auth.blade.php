    ...
    <div class="sidebar-wrapper">
        <ul class="nav">
            ...
            <li class="{{ $elementActive == 'icons' ? 'active' : '' }}">
                <a href="{{ route('icons', 'icons') }}">
                    <!-- <i class="nc-icon nc-diamond"></i> -->
                    <p>{{ __('APPOINTMENTS') }}</p>
                </a>
            </li>
            <li class="{{ $elementActive == 'typography' ? 'active' : '' }}">
                <a href="{{ route('pages.typography', 'typography') }}">
            ...
            ?>
                <li class="{{ $elementActive == 'userDashboard' ? 'active' : '' }}">
                ...
                <li class="{{ $elementActive == 'userAppointment' ? 'active' : '' }}">
                    <a href="{{ route('appointment') }}">
                        <!-- <i class="nc-icon nc-bank"></i> -->
                        <p>{{ __('Appointment') }}</p>
                    </a>
                </li>
                <li class="{{ $elementActive == 'userProcess' ? 'active' : '' }}">
            ...
            <li class="active-pro {{ $elementActive == 'upgrade' ? 'active' : '' }}">
                <a href="{{ route('logout') }}" class="bg-danger">
